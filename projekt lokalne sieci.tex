...
doprowadzone połączneia z hostów znajdujących się na danym piętrze
 o przepustowości 100Mb/s. W każdym budynku będzie znajdował się 1 switch obsługujący wirtualne sieci.
...
Adresy w strefie DMZ zostały szczegółowo wyspecyfikowane w tabeli \ref{table:konf_dmz} aby administrator sieci mógł dokładnie kontrolować ruch płynący na poszczególne serwery.
\begin{table}[H]
